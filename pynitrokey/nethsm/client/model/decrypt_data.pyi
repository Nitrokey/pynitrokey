...
class DecryptData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def decrypted() -> typing.Type['Base64']:
                return Base64
            __annotations__ = {
                "decrypted": decrypted,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["decrypted"]) -> 'Base64': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["decrypted", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["decrypted"]) -> 'Base64': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["decrypted", ], str]):
