...
class DecryptData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, decrypted, *args, **kwargs):  # noqa: E501
        """DecryptData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, decrypted, *args, **kwargs):  # noqa: E501
        """DecryptData - a model defined in OpenAPI
