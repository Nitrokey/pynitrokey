...
class SystemState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["Unprovisioned", "Locked", "Operational", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["Unprovisioned", "Locked", "Operational", ]  # noqa: E501
