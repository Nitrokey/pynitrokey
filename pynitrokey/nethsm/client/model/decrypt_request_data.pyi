...
class DecryptRequestData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def mode() -> typing.Type['DecryptMode']:
                return DecryptMode
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mode"]) -> 'DecryptMode': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode", "encrypted", "iv", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mode"]) -> 'DecryptMode': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode", "encrypted", "iv", ], str]):
