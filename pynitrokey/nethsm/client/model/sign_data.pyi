...
class SignData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def signature() -> typing.Type['Base64']:
                return Base64
            __annotations__ = {
                "signature": signature,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["signature"]) -> 'Base64': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["signature"]) -> 'Base64': ...
