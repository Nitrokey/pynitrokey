...
class EncryptMode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EncryptMode - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "AES_CBC", must be one of ["AES_CBC", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "AES_CBC", must be one of ["AES_CBC", ]  # noqa: E501
