...
class UserData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["realName", "role", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["realName", "role", ], str]):
