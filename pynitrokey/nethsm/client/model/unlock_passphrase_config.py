...
class UnlockPassphraseConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, passphrase, *args, **kwargs):  # noqa: E501
        """UnlockPassphraseConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, passphrase, *args, **kwargs):  # noqa: E501
        """UnlockPassphraseConfig - a model defined in OpenAPI
