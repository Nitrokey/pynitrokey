...
class LoggingConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ip_address, port, log_level, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, ip_address, port, log_level, *args, **kwargs):  # noqa: E501
        """LoggingConfig - a model defined in OpenAPI
