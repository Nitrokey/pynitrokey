...
class UnattendedBootConfig(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'Switch': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'Switch': ...
