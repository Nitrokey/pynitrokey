...
class HealthStateData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def state() -> typing.Type['SystemState']:
                return SystemState
            __annotations__ = {
                "state": state,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["state"]) -> 'SystemState': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["state"]) -> 'SystemState': ...
