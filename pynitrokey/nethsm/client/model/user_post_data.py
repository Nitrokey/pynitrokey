...
class UserPostData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, real_name, role, passphrase, *args, **kwargs):  # noqa: E501
        """UserPostData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, real_name, role, passphrase, *args, **kwargs):  # noqa: E501
        """UserPostData - a model defined in OpenAPI
