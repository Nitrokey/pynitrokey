...
class SignRequestData(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mode"]) -> 'SignMode': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode", "message", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mode"]) -> 'SignMode': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode", "message", ], str]):
