...
class KeyPrivateData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def primeP() -> typing.Type['Base64']:
                return Base64
        
            @staticmethod
            def primeQ() -> typing.Type['Base64']:
                return Base64
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primeP"]) -> 'Base64': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primeQ"]) -> 'Base64': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["primeP", "primeQ", "publicExponent", "data", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primeP"]) -> typing.Union['Base64', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primeQ"]) -> typing.Union['Base64', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["primeP", "primeQ", "publicExponent", "data", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        primeP: typing.Union['Base64', schemas.Unset] = schemas.unset,
        primeQ: typing.Union['Base64', schemas.Unset] = schemas.unset,
