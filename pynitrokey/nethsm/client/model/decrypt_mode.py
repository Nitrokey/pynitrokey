...
class DecryptMode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DecryptMode - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["RAW", "PKCS1", "OAEP_MD5", "OAEP_SHA1", "OAEP_SHA224", "OAEP_SHA256", "OAEP_SHA384", "OAEP_SHA512", "AES_CBC", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["RAW", "PKCS1", "OAEP_MD5", "OAEP_SHA1", "OAEP_SHA224", "OAEP_SHA256", "OAEP_SHA384", "OAEP_SHA512", "AES_CBC", ]  # noqa: E501
