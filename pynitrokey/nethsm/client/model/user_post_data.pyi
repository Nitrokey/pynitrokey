...
class UserPostData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def passphrase() -> typing.Type['Passphrase']:
                return Passphrase
            __annotations__ = {
                "realName": realName,
                "role": role,
    ...
    realName: MetaOapg.properties.realName
    role: 'UserRole'
    passphrase: 'Passphrase'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["passphrase"]) -> 'Passphrase': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["realName", "role", "passphrase", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["realName"]) -> MetaOapg.properties.realName: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["role"]) -> 'UserRole': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["passphrase"]) -> 'Passphrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["realName", "role", "passphrase", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        realName: typing.Union[MetaOapg.properties.realName, str, ],
        role: 'UserRole',
        passphrase: 'Passphrase',
