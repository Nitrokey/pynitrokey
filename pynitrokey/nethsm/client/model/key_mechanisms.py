...
def lazy_import():
    ...
    globals()['KeyMechanism'] = KeyMechanism


class KeyMechanisms(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """KeyMechanisms - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([KeyMechanism]):  # noqa: E501

        Keyword Args:
            value ([KeyMechanism]):  # noqa: E501
