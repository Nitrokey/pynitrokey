...
class InfoData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vendor, product, *args, **kwargs):  # noqa: E501
        """InfoData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vendor, product, *args, **kwargs):  # noqa: E501
        """InfoData - a model defined in OpenAPI
