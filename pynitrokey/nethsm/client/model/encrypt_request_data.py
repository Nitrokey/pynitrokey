...
def lazy_import():
    ...
    globals()['EncryptMode'] = EncryptMode


class EncryptRequestData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'mode': (EncryptMode,),  # noqa: E501
            'message': (Base64,),  # noqa: E501
            'iv': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mode, message, *args, **kwargs):  # noqa: E501
        """EncryptRequestData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, mode, message, *args, **kwargs):  # noqa: E501
        """EncryptRequestData - a model defined in OpenAPI
