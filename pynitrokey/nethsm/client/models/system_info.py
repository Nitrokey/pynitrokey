...
class SystemInfo(BaseModel):
    ...
    software_build: StrictStr = Field(..., alias="softwareBuild")
    ...
    ak_pub: Dict[str, Any] = Field(..., alias="akPub")
    pcr: Dict[str, Any] = Field(...)
    __properties = ["softwareVersion", "softwareBuild", "firmwareVersion", "hardwareVersion", "deviceId", "akPub", "pcr"]
