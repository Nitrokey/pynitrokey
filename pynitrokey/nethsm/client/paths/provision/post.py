...
# body param
SchemaForRequestBodyApplicationJson = ProvisionRequestData


request_body_provision_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _provision_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_provision_request_data.serialize(body, content_type)
...
class ProvisionPost(BaseApi):
    ...
    def provision_post(
        ...
        return self._provision_post_oapg(
            body=body,
