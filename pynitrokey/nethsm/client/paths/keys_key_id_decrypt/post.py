...
# body param
SchemaForRequestBodyApplicationJson = DecryptRequestData


request_body_decrypt_request_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DecryptData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_decrypt_post_oapg(
        self,
    ...
    def _keys_key_id_decrypt_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_decrypt_request_data.serialize(body, content_type)
...
class KeysKeyIdDecryptPost(BaseApi):
    ...
    def keys_key_id_decrypt_post(
        ...
        return self._keys_key_id_decrypt_post_oapg(
            body=body,
