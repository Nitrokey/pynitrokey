...
# body param
SchemaForRequestBodyApplicationJson = UserPostData


request_body_user_post_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _users_user_id_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_post_data.serialize(body, content_type)
...
class UsersUserIdPut(BaseApi):
    ...
    def users_user_id_put(
        ...
        return self._users_user_id_put_oapg(
            body=body,
