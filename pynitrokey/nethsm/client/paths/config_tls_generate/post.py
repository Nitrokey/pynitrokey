...
# body param
SchemaForRequestBodyApplicationJson = TlsKeyGenerateRequestData


request_body_tls_key_generate_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_tls_generate_post_oapg(
        self,
    ...
    def _config_tls_generate_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tls_key_generate_request_data.serialize(body, content_type)
...
class ConfigTlsGeneratePost(BaseApi):
    ...
    def config_tls_generate_post(
        ...
        return self._config_tls_generate_post_oapg(
            body=body,
