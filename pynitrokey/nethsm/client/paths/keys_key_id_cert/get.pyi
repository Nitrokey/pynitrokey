...
SchemaFor200ResponseBodyApplicationPgpKeys = schemas.StrSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    ...
    body: typing.Union[
        SchemaFor200ResponseBodyApplicationPgpKeys,
    ]
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/pgp-keys': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationPgpKeys),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_cert_get_oapg(
        self,
...
class KeysKeyIdCertGet(BaseApi):
    ...
    def keys_key_id_cert_get(
        ...
        return self._keys_key_id_cert_get_oapg(
