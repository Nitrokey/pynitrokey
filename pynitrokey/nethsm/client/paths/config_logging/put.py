...
# body param
SchemaForRequestBodyApplicationJson = LoggingConfig


request_body_logging_config = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _config_logging_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_logging_config.serialize(body, content_type)
...
class ConfigLoggingPut(BaseApi):
    ...
    def config_logging_put(
        ...
        return self._config_logging_put_oapg(
            body=body,
