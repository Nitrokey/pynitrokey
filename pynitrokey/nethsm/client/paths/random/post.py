...
# body param
SchemaForRequestBodyApplicationJson = RandomRequestData


request_body_random_request_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RandomData
...
class BaseApi(api_client.Api):
    ...
    def _random_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_random_request_data.serialize(body, content_type)
