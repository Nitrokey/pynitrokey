...
from pynitrokey.nethsm.client.paths.keys.post.parameters.parameter_0 import schema
from pynitrokey.nethsm.client.paths.keys.post.parameters.parameter_1 import schema as schema_2
