...
from pynitrokey.nethsm.client.paths.keys_key_id_restrictions_tags_tag.put.parameters.parameter_0 import schema as schema_2
from pynitrokey.nethsm.client.paths.keys_key_id_restrictions_tags_tag.put.parameters.parameter_1 import schema
