...
from pynitrokey.nethsm.client.paths.users_user_id_tags_tag.put.parameters.parameter_0 import schema
from pynitrokey.nethsm.client.paths.users_user_id_tags_tag.put.parameters.parameter_1 import schema as schema_2
