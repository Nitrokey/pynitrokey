...
# body param
SchemaForRequestBodyApplicationJson = NetworkConfig


request_body_network_config = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _config_network_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_network_config.serialize(body, content_type)
...
class ConfigNetworkPut(BaseApi):
    ...
    def config_network_put(
        ...
        return self._config_network_put_oapg(
            body=body,
