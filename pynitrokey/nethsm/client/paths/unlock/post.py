...
# body param
SchemaForRequestBodyApplicationJson = UnlockRequestData


request_body_unlock_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _unlock_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_unlock_request_data.serialize(body, content_type)
