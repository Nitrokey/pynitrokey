...
# body param
SchemaForRequestBodyApplicationJson = TimeConfig


request_body_time_config = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _config_time_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_time_config.serialize(body, content_type)
...
class ConfigTimePut(BaseApi):
    ...
    def config_time_put(
        ...
        return self._config_time_put_oapg(
            body=body,
