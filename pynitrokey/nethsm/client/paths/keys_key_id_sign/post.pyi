...
# body param
SchemaForRequestBodyApplicationJson = SignRequestData


request_body_sign_request_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SignData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_sign_post_oapg(
        self,
    ...
    def _keys_key_id_sign_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sign_request_data.serialize(body, content_type)
...
class KeysKeyIdSignPost(BaseApi):
    ...
    def keys_key_id_sign_post(
        ...
        return self._keys_key_id_sign_post_oapg(
            body=body,
