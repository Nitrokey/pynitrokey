...
# body param
SchemaForRequestBodyApplicationJson = KeyGenerateRequestData


request_body_key_generate_request_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _keys_generate_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_key_generate_request_data.serialize(body, content_type)
...
class KeysGeneratePost(BaseApi):
    ...
    def keys_generate_post(
        ...
        return self._keys_generate_post_oapg(
            body=body,
