...
# body param
SchemaForRequestBodyApplicationJson = EncryptRequestData


request_body_encrypt_request_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EncryptData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_encrypt_post_oapg(
        self,
    ...
    def _keys_key_id_encrypt_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_encrypt_request_data.serialize(body, content_type)
...
class KeysKeyIdEncryptPost(BaseApi):
    ...
    def keys_key_id_encrypt_post(
        ...
        return self._keys_key_id_encrypt_post_oapg(
            body=body,
