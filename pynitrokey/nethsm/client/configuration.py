...
conf = pynitrokey.nethsm.client.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://nethsmdemo.nitrokey.com/api/v1" if host is None else host
        """Default Base url
        """
        ...
        return [
            {
                ...
                'variables': {
                    'host': {
                        'description': "No description provided",
                        'default_value': "nethsmdemo.nitrokey.com",
                        },
                    'version': {
                        'description': "No description provided",
                        'default_value': "v1",
