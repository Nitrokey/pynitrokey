...
from pynitrokey.nethsm.client import rest
from pynitrokey.nethsm.client.configuration import Configuration
from pynitrokey.nethsm.client.exceptions import ApiTypeError, ApiValueError, ApiException
from pynitrokey.nethsm.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.config_backup_passphrase_put  # this is an instance of the class Endpoint
        api_instance.config_backup_passphrase_put()  # this invokes api_instance.config_backup_passphrase_put.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.config_backup_passphrase_put.callable or self.callable in this class
