...
@click.option("--experimental", default=False, is_flag=True, help="Allow to execute experimental features")
@click.pass_obj
def update(ctx: Context, image: str, experimental: bool) -> None:
    ...
    if platform.system() == 'Windows' and not experimental:
        local_critical('We experience some issues with this operation on Windows. '
